...
| 22  | **Arbeitnow** ✅                      | https://www.arbeitnow.com                              | `https://www.arbeitnow.com/api/job-board-api`                                                | No                  | LOW          | Free public JSON API. Paginated, 100/page.                                                                                                                                                                                                                                                                                                                                                                                             |
| 23  | **Jobicy** ✅                         | https://jobicy.com                                     | `https://jobicy.com/api/v2/remote-jobs`                                                      | No                  | LOW          | Free public API. Structured JSON with salary, industry, level, geo.                                                                                                                                                                                                                                                                                                                                                                    |
...
| 28  | **Working Nomads** ✅                 | https://workingnomads.com                              | RSS per category                                                                             | No                  | LOW (RSS)    | Remote job board with RSS feeds per category.                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 33  | **RemoteWLB** ✅                      | https://www.remotewlb.com                              | GitHub open data (`RemoteWLB/remote-jobs`)                                                   | No                  | LOW (data)   | Aggregates 200K+ jobs from 8K+ companies. Open source data on GitHub.                                                                                                                                                                                                                                                                                                                                                                  |
